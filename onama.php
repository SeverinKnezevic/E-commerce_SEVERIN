...
<p><ol class="breadcrumb">
	...
	<text id="nalazitese">  Nalazite se u: </text><li class="active"><a href="onama.html">O nama</a></li>
</ol></p> 
...
.
				...
				<h3 align="center"> Povijest </h3>
					<p>
						...
						Svih ovih godina držali smo se temeljnih načela koje su ovu tvrtku dovele do lidera u ovom dijelu zemlje.  </p>
					</br>
