...
<!-- POKRETNE SLIKE-->	
	...
	<li class="go_back"> <a href="javascript:history.back()"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span><b>Povratak</b></a> </li> 
		<text id="nalazitese">  Nalazite se u:</text> <li class="active"><a href="trebatepomoc.html">Trebate pomoć?</a></li>
		</ol></p> 
			...
			<hr>
				...
				<h3 align="center"> Naručiti telefonom ili E-mailom </h3>
						<text align="center">
							...
							ili </br>
							e-mailom tako sto ce te ispuniti obrazac <a href="kontakt.php" >kontakt</a> .
						</text>
					</br>
					</br>
				</section>
